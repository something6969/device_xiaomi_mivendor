...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_no_dolbyencoder_vendor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_no_dolbyencoder_vendor.xml \
...
# Inherit vendor
$(call inherit-product, vendor/xiaomi/mivendor/mivendor-vendor.mk)